...
public class nextScreen9 extends JPanel implements ActionListener{
	JFrame window = new JFrame();
	JLabel picture = new JLabel();
	JPanel backgroundPanel = new JPanel();
	JTextArea txt =  new JTextArea();
	private final JPanel btnPanel = new JPanel();
	private final JButton btnTwo = new JButton("Find shutdown button");
	private final JButton btnOne = new JButton("Back");

	nextScreen9(Inventory testInv){
		btnPanel.setBackground(Color.BLACK);
		txt.setLineWrap(true);
		txt.setText("Oh wow! The portal was real! "
				+ "I need to shut it down to save everyone!"
				+ "Where is the button? "
	);
		...
		picture.setIcon(new ImageIcon("C:\\\\Users\\\\opadm\\\\eclipse-workspace\\\\CSIS 2450_TeamProject\\\\media\\\\Portal.png"));
		
		btnTwo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				nextScreen12 next = new nextScreen12(testInv);
				window.dispose();
			}
		});
