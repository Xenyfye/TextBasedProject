	...
	endScreen(Inventory testInv){
		...
		gl_btnPanel.setHorizontalGroup(
			gl_btnPanel.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_btnPanel.createSequentialGroup()
					.addGap(32)
					.addComponent(endGame, GroupLayout.DEFAULT_SIZE, 173, Short.MAX_VALUE)
					.addGap(29))
		);
		...
		picture.setIcon(new ImageIcon("C:\\Users\\opadm\\eclipse-workspace\\CSIS 2450_TeamProject\\media\\Scary Face Resize.gif"));
